...
def it_53(k, dlina, visota, ram):
    if k[7] == 'ПСЯ':
        return it_63.it_63(k, dlina, visota, RAM)

    txt_ss = ''
    oBv = [27, 33, 61.5, 14.101, 23.301, 12.201, 21.401, 12, 27.5, 6, 0, 0]
    ...
    if k[7] == 'Фасад' and int(visota) >= 266:
        txt_ss = open('rs/53_it/f.txt', 'r').read()
        RAMX, RAMY = 74, 44.5
        ...
        txt_ss = open('rs/53_it/st.txt', 'r').read()
        RAMX, RAMY = 74, 44.5
        BRAMX = 74 - (320 - int(visota)) * 0.2 if int(visota) <= 320 else 74
        ...
        txt_ss = open('rs/53_it/xl.txt', 'r').read()
        RAMX, RAMY = 74, 44.5
        ...
        txt_ss = open('rs/53_it/xlst.txt', 'r').read()
        RAMX, RAMY = 74, 44.5
        BRAMX = 74 - (320 - int(dlina)) * 0.2 if int(dlina) <= 320 else 74
        ...
        txt_ss = open('rs/53_it/but.txt', 'r').read()
        oBv[1] = oBv[0]
        RAMX, RAMY = 74, ram[1]
        if int(visota) <= 270:
