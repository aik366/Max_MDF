oBv91it = [27, 33, 61.5, 23.301, 21.401, 14.101, 12.201, 12, 27.5, 6, 10.4, 1.4]


def it_91(k, dlina, visota, RAM):
    txt_ss = ''
    oBv = oBv91it.copy()

    if k[7] in ('Фасад', 'Хлеб'):
        txt_ss = open('rs/91_it/f.txt', 'r').read()
        ...
        txt_ss = open('rs/91_it/f2.txt', 'r').read()
        ...
        oBv[1] = oBv[8]
        txt_ss = open('rs/91_it/st.txt', 'r').read()
        RAMX, RAMY = RAM[0], RAM[0]
        txt_ss = txt_ss.replace('RAMX', str(RAMX))
        txt_ss = txt_ss.replace('RAMY', str(RAMY))
        for i in range(10):
        ...
        oBv[1] = oBv[8]
        txt_ss = open('rs/91_it/per.txt', 'r').read()
        RAMX, RAMY = RAM[0], RAM[0]
        ...
        oBv[1] = oBv[8]
        txt_ss = open('rs/91_it/per4.txt', 'r').read()
        RAMX, RAMY = RAM[0], RAM[0]
        ...
        oBv[1] = oBv[8]
        txt_ss = open('rs/91_it/per8.txt', 'r').read()
        RAMX, RAMY = RAM[0], RAM[0]
        ...
        txt_ss = open('rs/91_it/ps.txt', 'r').read()
