def it_30(k, dlina, visota, RAM):
    txt_ss = ''
    Kant = '10.4' if k[5] == '18' else '14.8'

    if k[7] == 'Фасад':
        txt_ss = open('rs/30_it/f.txt', 'r').read()
        ...
        txt_ss = open('rs/30_it/st.txt', 'r').read()
        ...
        txt_ss = open('rs/30_it/xl.txt', 'r').read()
        ...
        txt_ss = open('rs/30_it/xlst.txt', 'r').read()
