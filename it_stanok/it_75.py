def it_75(k, dlina, visota, RAM):
    txt_ss = ''
    oBv = [27, 33, 61.5, 23.301, 21.401, 14.101, 12.201, 12, 27.5, 6]
    Txt65_1 = open('rs/75_it/65_1.txt', 'r').read()
    Txt65_2 = open('rs/75_it/65_2.txt', 'r').read()
    Txt65_3 = open('rs/75_it/65_3.txt', 'r').read()
    Txt65_4 = open('rs/75_it/65_4.txt', 'r').read()

    if k[7] in ('Фасад', 'Хлеб'):
        txt_ss = open('rs/75_it/f.txt', 'r').read()
        ...
        oBv[1] = oBv[8]
        txt_ss = open('rs/75_it/st.txt', 'r').read()
        RAMX, RAMY = RAM[0], RAM[0]
        f = RAMX + oBv[6] - 7.7
        fx, fy, f2x, f2y = f, f, f, f
        ko = round(((int(dlina) - 2 * f) / 9), 0)
        ...
        txt_ss = open('rs/75_it/pssl.txt', 'r').read()
        RAMX, RAMY = RAM[0], RAM[1] + 8
        f = RAMX + oBv[6] - 7.7
        m = RAMY + oBv[6] - 7.7
        fx, fy, f2x, f2y = f, m, f, m
        ko = round(((int(dlina) - 2 * f) / 9), 0)
        ...
        txt_ss = open('rs/75_it/ps.txt', 'r').read()
        RAMX, RAMY = RAM[0], RAM[1] + 8
        f = RAMX + oBv[6] - 7.7
        m = RAMY + oBv[6] - 7.7
        fx, fy, f2x, f2y = f, m, f, m
