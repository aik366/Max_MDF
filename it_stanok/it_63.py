def it_63(k, dlina, visota, RAM):
    ...
    if k[7] == 'Фасад':
        ...
        oBv[1] = oBv[8]
        txt_ss = open('rs/63_it/st.txt', 'r').read()
        RAMY = 44.5
        RAMX = 74 if int(visota) > 319 else 74 - (320 - int(visota)) * 0.2
        RAMK = 67.54 + (int(visota) - 360) * 0.08 if int(visota) > 360 else 67.5 - (360 - int(visota)) * 0.025
        ty0 = (int(visota) - 2 * RAMK) / 4
        ...
        txt_ss = open('rs/63_it/xl.txt', 'r').read()
        RAMY = 44.5
        ...
        oBv[1] = oBv[8]
        txt_ss = open('rs/63_it/xl_st.txt', 'r').read()
        RAMY = 44.5
        RAMX = 74 if int(dlina) > 319 else 74 - (320 - int(dlina)) * 0.2
        RAMK = 67.54 + (int(dlina) - 360) * 0.08 if int(dlina) > 360 else 67.5 - (360 - int(dlina)) * 0.025
        ty0 = (int(dlina) - 2 * RAMK) / 4
        ...
        txt_ss = open('rs/63_it/but.txt', 'r').read()
        RAMX, RAMK = 71, 44.5
        ...
        txt_ss = open('rs/63_it/butsl.txt', 'r').read()
        ...
        txt_ss = open('rs/63_it/ps.txt', 'r').read()
        ...
        txt_ss = open('rs/63_it/pssl.txt', 'r').read()
        RAMX, RAMY, RAMK = 61, 22.5, 35
        ty0 = (int(visota) - 2 * RAMY) / 4
        tx0 = (RAMX - RAMK) / 2
        rRr = (tx0 * tx0 + ty0 * ty0) / (2 * tx0)
        ...
        txt_ss = open('rs/63_it/pssl2.txt', 'r').read()
        RAMX, RAMY, RAMK = 61, 22.5, 35
        ty0 = (int(visota) - 2 * RAMY) / 4
        tx0 = (RAMX - RAMK) / 2
        rRr = (tx0 * tx0 + ty0 * ty0) / (2 * tx0)
