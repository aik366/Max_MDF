...
def it_55(k, dlina, visota, RAM):
    ...
    if k[7] == 'Фасад':
        txt_ss = open('rs/55_it/f.txt', 'r').read()
        ...
        oBv[1] = oBv[8]
        txt_ss = open('rs/55_it/st.txt', 'r').read()
        RAMX, RAMY, rRr1, tx0 = 113, 44.5, 21.5, 36.3
        RAMK = RAMY + (int(visota) - 305) * 0.125 if int(visota) > 305 else RAMY + 0.001
        ty0 = (rRr1 ** 2 - (tx0 - rRr1) ** 2) ** 0.5
        tx1 = RAMX - RAMY - tx0
        ...
        txt_ss = open('rs/55_it/xl.txt', 'r').read()
        RAMX, RAMY, rRr1, tx0 = 113, 44.5, 21.5, 36.3
        ...
        oBv[1] = oBv[8]
        txt_ss = open('rs/55_it/xl_st.txt', 'r').read()
        RAMX, RAMY, rRr1, tx0 = 113, 44.5, 21.5, 36.3
        RAMK = RAMY + (int(dlina) - 305) * 0.125 if int(dlina) > 305 else RAMY + 0.001
        ty0 = (rRr1 ** 2 - (tx0 - rRr1) ** 2) ** 0.5
        tx1 = RAMX - RAMY - tx0
        ...
        txt_ss = open('rs/55_it/but.txt', 'r').read()
        ...
        txt_ss = open('rs/55_it/butsl.txt', 'r').read()
        ...
        txt_ss = open('rs/55_it/butsl2.txt', 'r').read()
        RAMX, RAMY, RAMZ, rRr1, tx0, oBv[0] = 113, 29.5, 44.5, 21.5, 36.3, 17
        RAMK = RAMY + (int(visota) - 305) * 0.125 if int(visota) > 305 else RAMY + 0.001
        ty0 = (rRr1 ** 2 - (tx0 - rRr1) ** 2) ** 0.5
        tx1 = RAMX - RAMZ - tx0
