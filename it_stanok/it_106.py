def it_106(k, dlina, visota, RAM):
    txt_ss = ''
    oBv = [27, 33, 15.0001, 23.301, 22.301, 32.2001, 21.401, 33.6, 27.5, 13.1]
    oBv[9] = oBv[2] - (oBv[3] - oBv[4])

    if k[7] in ('Фасад', 'Хлеб'):
        txt_ss = open('rs/106_it/f.txt', 'r').read()
        ...
        txt_ss = open('rs/106_it/f2.txt', 'r').read()
        ...
        oBv[1] = oBv[8]
        txt_ss = open('rs/106_it/st.txt', 'r').read()
        RAMX, RAMY = RAM[0], RAM[0]
        txt_ss = txt_ss.replace('RAMX', str(RAMX))
        txt_ss = txt_ss.replace('RAMY', str(RAMY))
        for i in range(10):
        ...
        oBv[1] = oBv[8] - 5
        txt_ss = open('rs/106_it/per.txt', 'r').read()
        RAMX, RAMY = RAM[0], RAM[0]
        ...
        oBv[1] = oBv[8] - 5
        txt_ss = open('rs/106_it/per4.txt', 'r').read()
        RAMX, RAMY = RAM[0], RAM[0]
        ...
        oBv[1] = oBv[8] - 5
        txt_ss = open('rs/106_it/per8.txt', 'r').read()
        RAMX, RAMY = RAM[0], RAM[0]
        ...
        txt_ss = open('rs/106_it/ps.txt', 'r').read()
        RAMX, RAMY = RAM[0], RAM[1]
        txt_ss = txt_ss.replace('RAMX', str(RAMX))
        txt_ss = txt_ss.replace('RAMY', str(RAMY))
        for i in range(10):
