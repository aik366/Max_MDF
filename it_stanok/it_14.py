def it_14(k, dlina, visota, RAM):
    txt_ss = ''
    if k[7] == 'Фасад':
        txt_ss = open('rs/14_it/f.txt', 'r').read()
        RAMX, RAMY = 120, 70
        tx1 = (RAMX - RAMY) / 2
        ...
        txt_ss = open('rs/14_it/xl.txt', 'r').read()
        RAMX, RAMY = 120, 70
        tx1 = (RAMX - RAMY) / 2
        ...
        txt_ss = open('rs/14_it/st.txt', 'r').read()
        RAMX, RAMY = 120, 70
        tx1 = (RAMX - RAMY) / 2
        ty1 = (int(visota) - 2 * RAMY) / 4
        rRr = (tx1 * tx1 + ty1 * ty1) / (2 * tx1)
        ...
        txt_ss = open('rs/14_it/xlst.txt', 'r').read()
        RAMX, RAMY = 120, 70
        tx1 = (RAMX - RAMY) / 2
        ty1 = (int(dlina) - 2 * RAMY) / 4
        rRr = (tx1 * tx1 + ty1 * ty1) / (2 * tx1)
    ...
    elif k[7] in ('ПСЯ', 'Бутыл.') and 129 <= int(visota) < 140:
        txt_ss = open('rs/14_it/ps.txt', 'r').read()
    ...
    elif k[7] in ('ПСЯ', 'Бутыл.') and int(visota) < 129:
        txt_ss = open('rs/14_it/ps.txt', 'r').read()
