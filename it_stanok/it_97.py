...
def it_97(k, dlina, visota, RAM):
    ...
    if k[7] in ('Фасад', 'Хлеб'):
        txt_ss = open('rs/97_it/f.txt', 'r').read()
        ...
        txt_ss = open('rs/97_it/f2.txt', 'r').read()
        RAMX, RAMY, lxp, zaz = RAM[0], RAM[0], RAM[2], 50
        ...
        txt_ss = open('rs/97_it/ps.txt', 'r').read()
