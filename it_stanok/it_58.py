...
def it_58(k, dlina, visota, RAM):
    ...
    if k[7] == 'Фасад' and int(visota) >= 266:
        txt_ss = open('rs/58_it/f.txt', 'r').read()
        RAMX, RAMY = 74, 44.5
        ...
        txt_ss = open('rs/58_it/st.txt', 'r').read()
        RAMX, RAMY = 74, 44.5
        BRAMX = 74 - (320 - int(visota)) * 0.2 if int(visota) <= 320 else 74
        ...
        txt_ss = open('rs/58_it/xl.txt', 'r').read()
        RAMX, RAMY = 74, 44.5
        ...
        txt_ss = open('rs/58_it/xlst.txt', 'r').read()
        RAMX, RAMY = 74, 44.5
        BRAMX = 74 - (320 - int(dlina)) * 0.2 if int(dlina) <= 320 else 74
        ...
        txt_ss = open('rs/58_it/but.txt', 'r').read()
        oBv[1] = oBv[0]
        RAMX, RAMY = 74, 22.5
        if int(visota) <= 270:
