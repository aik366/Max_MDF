def it_104(k, dlina, visota, RAM):
    txt_ss = ''
    oBv = [27, 37, 63.5, 23.301, 22.301, -6, 13, 33.6, 27.5, 21.901, 10.4, 1.4]

    if k[7] in ('Фасад', 'Хлеб'):
        txt_ss = open('rs/104_it/f.txt', 'r').read()
        ...
        txt_ss = open('rs/104_it/f2.txt', 'r').read()
        RAMX, RAMY, lxp, zaz = RAM[0], RAM[0], RAM[2], 52 + (RAM[0] - 44.5)
        ...
        oBv[1] = oBv[8]
        txt_ss = open('rs/104_it/st.txt', 'r').read()
        RAMX, RAMY = RAM[0], RAM[0]
        txt_ss = txt_ss.replace('RAMX', str(RAMX))
        txt_ss = txt_ss.replace('RAMY', str(RAMY))
        for i in range(10):
        ...
        oBv[1] = oBv[8] - 5
        txt_ss = open('rs/104_it/per.txt', 'r').read()
        RAMX, RAMY = 44.5, 44.5
        ...
        oBv[1] = oBv[8] - 5
        txt_ss = open('rs/104_it/per4.txt', 'r').read()
        RAMX, RAMY = RAM[0], RAM[0]
        ...
        oBv[1] = oBv[8] - 5
        txt_ss = open('rs/104_it/per8.txt', 'r').read()
        RAMX, RAMY = RAM[0], RAM[0]
        ...
        txt_ss = open('rs/104_it/pssl.txt', 'r').read()
        oBv[5] = 2
        RAMX, RAMY = RAM[0], RAM[1] + 4
        txt_ss = txt_ss.replace('RAMX', str(RAMX))
        txt_ss = txt_ss.replace('RAMY', str(RAMY))
        ...
        txt_ss = open('rs/104_it/ps.txt', 'r').read()
        RAMX, RAMY = RAM[0], RAM[1] + 4
        txt_ss = txt_ss.replace('RAMX', str(RAMX))
        txt_ss = txt_ss.replace('RAMY', str(RAMY))
        for i in range(10):
