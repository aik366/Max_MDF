from it_stanok import it_59


def it_60(k, dlina, visota, RAM):
    if k[7] == 'ПСЯ':
        return it_59(k, dlina, visota, RAM)
    ...
    if k[7] == 'Фасад':
        txt_ss = open('rs/60_it/f.txt', 'r').read()
        RAMX, RAMY = 96, 44.5
        RAMK = RAMX - RAMY
        ...
        txt_ss = open('rs/60_it/xl.txt', 'r').read()
        RAMX, RAMY = 96, 44.5
        RAMK = RAMX - RAMY
        ...
        txt_ss = open('rs/60_it/st.txt', 'r').read()
        oBv[1] = oBv[8]
        RAMX, RAMY = 96, 44.5
        RAMK = RAMX - RAMY
        ty1 = (int(visota) - RAMY * 2) / 2
        ...
        txt_ss = open('rs/60_it/xlst.txt', 'r').read()
        oBv[1] = oBv[8]
        RAMX, RAMY = 96, 44.5
        RAMK = RAMX - RAMY
        ty1 = (int(dlina) - RAMY * 2) / 2
        ...
        txt_ss = open('rs/60_it/but.txt', 'r').read()
        ...
        txt_ss = open('rs/60_it/butsl.txt', 'r').read()
        RAMY = 22.5
        RAMX, RAMK, oBv[2] = 80, 35.5, 20
        RAMZ = RAMX - RAMK
