def it_11(k, dlina, visota, RAM):
    txt_ss = ''
    if k[7] == 'Фасад':
        txt_ss = open('rs/11_it/f.txt', 'r').read()
        RAMX, RAMY = 120, 70
        ...
        txt_ss = open('rs/11_it/xl.txt', 'r').read()
        RAMX, RAMY = 120, 70
        ...
        txt_ss = open('rs/11_it/st.txt', 'r').read()
        RAMX, RAMY = 120, 70
        rRr = (((int(visota) - 2 * RAMY) / 2) ** 2 + (RAMX - RAMY) ** 2) / (2 * (RAMX - RAMY))
        ...
        txt_ss = open('rs/11_it/xlst.txt', 'r').read()
        RAMX, RAMY = 120, 70
        rRr = (((int(dlina) - 2 * RAMY) / 2) ** 2 + (RAMX - RAMY) ** 2) / (2 * (RAMX - RAMY))
