def nc_108(k, dlina, visota, RAM):
    txt_ss = ''
    konec, shag, gl = 0, 38.0, 10.001

    oBv = [27, 29, 15.0001, 22.3001, 20.4051, 32.2001, 20.4051, 34.0701, 22, 13.1301]

    if k[7] in ('Фасад', 'Хлеб'):
        txt_ss = open('rs/108/f.txt', 'r').read()
        ...
        txt_ss = open('rs/108/ps.txt', 'r').read()
