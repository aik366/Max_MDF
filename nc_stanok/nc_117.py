from nc_stanok.nc_118 import nc_118

def nc_117(k, dlina, visota, RAM):
    if k[7] in ('СТЕКЛО', 'Хлеб_ст', 'ПЕРЕПЛЕТ', 'ПЕРЕПЛЕТ2', 'ПЕРЕПЛЕТ4', 'ПЕРЕПЛЕТ4_xl', 'ПЕРЕПЛЕТ8'):
        return nc_118(k, dlina, visota, RAM)

    txt_ss = ''
    konec, shag, gl = 0, 38.0, 10.001

    oBv = [27, 29, 5.4, 22.3001, 20.4051, 32.2001, 20.4051, 34.0701, 22, 15]
