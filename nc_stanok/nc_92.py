oBv92nc = [27, 33, 61.5, 13.6001, 22.3001, 11.7301, 20.4301, 27.5, 10.6, 19]

def nc_92(k, dlina, visota, RAM):
    txt_ss = ''
    oBv = oBv92nc.copy()

    if k[7] == 'Фасад':
        txt_ss = open('rs/92/f.txt', 'r').read()
        ...
        txt_ss = open('rs/92/f2.txt', 'r').read()
    ...
    if k[7] == 'Хлеб':
        txt_ss = open('rs/92/xl.txt', 'r').read()
        RAMX, RAMY = RAM[0], RAM[0]
        txt_ss = txt_ss.replace('RAMX', str(RAMX))
        txt_ss = txt_ss.replace('RAMY', str(RAMY))
        for i in range(10):
        ...
        oBv[1] = oBv[7]
        txt_ss = open('rs/92/st.txt', 'r').read()
        RAMX, RAMY = RAM[0], RAM[0]
        txt_ss = txt_ss.replace('RAMX', str(RAMX))
        txt_ss = txt_ss.replace('RAMY', str(RAMY))
        for i in range(10):
        ...
        oBv[1] = oBv[7]
        txt_ss = open('rs/92/xlst.txt', 'r').read()
        RAMX, RAMY = RAM[0], RAM[0]
        txt_ss = txt_ss.replace('RAMX', str(RAMX))
        txt_ss = txt_ss.replace('RAMY', str(RAMY))
        for i in range(10):
        ...
        oBv[1] = oBv[7]
        txt_ss = open('rs/92/per.txt', 'r').read()
        RAMX, RAMY = RAM[0], RAM[0]
        zaz = 1
        ...
        oBv[1] = oBv[7]
        txt_ss = open('rs/92/perxl.txt', 'r').read()
        RAMX, RAMY = RAM[0], RAM[0]
        zaz = 1
        Lst = (int(dlina) - 106 - zaz * 2) / 3 + 106
        Wst = (int(visota) - 106 - zaz) / 2 + 106
        ...
        oBv[1] = oBv[7]
        txt_ss = open('rs/92/per4.txt', 'r').read()
        RAMX, RAMY = RAM[0], RAM[0]
        zaz = 3
        ...
        oBv[1] = oBv[7]
        txt_ss = open('rs/92/per4xl.txt', 'r').read()
        RAMX, RAMY = RAM[0], RAM[0]
        zaz = 3
        Lst = (int(dlina) - 106 - zaz) / 2 + 106
        Wst = (int(visota) - 106 - zaz) / 2 + 106
        ...
        oBv[1] = oBv[7]
        txt_ss = open('rs/92/per8.txt', 'r').read()
        RAMX, RAMY = RAM[0], RAM[0]
        zaz = 3
        ...
        txt_ss = open('rs/92/ps.txt', 'r').read()
        ...
        txt_ss = open('rs/92/but.txt', 'r').read()
        RAMX, RAMY = RAM[0], RAM[1]
        txt_ss = txt_ss.replace('RAMX', str(RAMX))
        txt_ss = txt_ss.replace('RAMY', str(RAMY))
        for i in range(10):
