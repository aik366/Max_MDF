def ss_12(k, dlina, visota, RAM):
    txt_ss = ''
    if k[7] == 'Фасад':
        txt_ss = open('rs/12/f.txt', 'r').read()
        txt_ss = txt_ss.replace('RAMX', '70')
        txt_ss = txt_ss.replace('RAMY', '120')

    elif k[7] =='Хлеб':
        txt_ss = open('rs/12/xl.txt', 'r').read()
        txt_ss = txt_ss.replace('RAMX', '70')
        txt_ss = txt_ss.replace('RAMY', '120')

    elif k[7] == 'СТЕКЛО':
        txt_ss = open('rs/12/st.txt', 'r').read()
        txt_ss = txt_ss.replace('RAMX', '70')
        txt_ss = txt_ss.replace('RAMY', '120')

    elif k[7] == 'Хлеб_ст':
        txt_ss = open('rs/12/xlst.txt', 'r').read()
        txt_ss = txt_ss.replace('RAMX', '70')
        txt_ss = txt_ss.replace('RAMY', '120')
