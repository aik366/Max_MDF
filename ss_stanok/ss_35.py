def ss_35(k, dlina, visota, RAM):
    txt_ss = ''
    Kant = '10.4' if k[5] == '18' else '14.8'
    if k[7] == 'Фасад':
        txt_ss = open('rs/35/f.txt', 'r').read()
        ...
        txt_ss = open('rs/35/st.txt', 'r').read()
        ...
        txt_ss = open('rs/35/xl.txt', 'r').read()
        ...
        txt_ss = txt_ss.replace("Kant", str(Kant))
        if int(visota) < 525:
            txt_ss = txt_ss.replace("@200", str(int(visota) - 187))
            txt_ss = txt_ss.replace("@225", str(int(visota) - 172))

    elif k[7] =='Хлеб_ст':
        txt_ss = open('rs/35/xlst.txt', 'r').read()
        ...
        txt_ss = open('rs/35/but.txt', 'r').read()
        ...
        txt_ss = open('rs/35/butsl.txt', 'r').read()
