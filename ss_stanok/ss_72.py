from ss_stanok import ss_91

oBv72ss = [27, 33, 61.5, 13.6, 22.21, 12.2001, 20.7501, 27.5, 10.6, 19]


def ss_72(k, dlina, visota, RAM):
    txt_ss = ''
    oBv = oBv72ss.copy()
    if (k[7] == 'Фасад' and int(visota) < 250) or k[7] in ('СТЕКЛО', 'Хлеб_ст', 'ПЕРЕПЛЕТ', 'ПЕРЕПЛЕТ2',
                                                           'ПЕРЕПЛЕТ4', 'ПЕРЕПЛЕТ8', 'Бутыл.', 'Планка'):
        return ss_91.ss_91(k, dlina, visota, RAM)
