def stol_ss(i, ll, ww, rad, st_v):
    txt_stol = open('pl/16_stol.txt', 'r').read()
    ...
    if i[4][2] in ("д", 'к'):
        ...
        if i[5] == '18':
            ...
            txt_st = open('rs/stol/4st.txt', 'r').read()
        ...
        if i[5] == '18' and i[4][0] == "п":
            ...
            txt_stol = txt_stol.replace("WEEKE BHC T.", "БАЗА №8")
        elif i[5] == '18' and i[4][0] == "л":
            txt_st = open('rs/stol/1d1k_R_18.txt', 'r').read()
            txt_stol = txt_stol.replace("WEEKE BHC T.", "БАЗА №5")
        elif i[4][0] == "п":
    ...
    if i[5] == "14":
        ...
        if int(ll) < 75 or int(ww) < 75:
            ...
            txt_stol = txt_stol.replace("frez", "151")
            txt_stol = txt_stol.replace("Hfrz", "t-16.7")

    elif i[5] == "15":
        txt_stol = txt_stol.replace("AB_0", "0")
        txt_stol = txt_stol.replace("frez", "155")
        txt_stol = txt_stol.replace("Hfrz", "t-13")
        ...
        if int(ll) < 75 or int(ww) < 75:
            ...
            txt_stol = txt_stol.replace("Hfrz", "t-19")
        ...
        txt_stol = txt_stol.replace("Hfrz", "-2")
        ...
        if int(ll) < 75 or int(ww) < 75:
            ...
            txt_stol = txt_stol.replace("Hfrz", "t-19.4")
