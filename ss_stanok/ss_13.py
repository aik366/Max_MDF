def ss_13(k, dlina, visota, RAM):
    txt_ss = ''
    if k[7] == 'Фасад':
        txt_ss = open('rs/13/f.txt', 'r').read()
        RAMX, RAMY = 120, 70
        tx1 = (RAMX - RAMY) / 2
        ...
        txt_ss = open('rs/13/xl.txt', 'r').read()
        RAMX, RAMY = 120, 70
        tx1 = (RAMX - RAMY) / 2
        ...
        txt_ss = open('rs/13/st.txt', 'r').read()
        RAMX, RAMY = 120, 70
        tx1 = (RAMX - RAMY) / 2
        ty1 = (int(visota) - 2 * RAMY) / 4
        rRr = (tx1 * tx1 + ty1 * ty1) / (2 * tx1)
        ...
        txt_ss = open('rs/13/xl_st.txt', 'r').read()
        RAMX, RAMY = 120, 70
        tx1 = (RAMX - RAMY) / 2
        ty1 = (int(dlina) - 2 * RAMY) / 4
        rRr = (tx1 * tx1 + ty1 * ty1) / (2 * tx1)
        ...
        txt_ss = open('rs/13/but.txt', 'r').read()
        ...
        txt_ss = open('rs/13/butsl.txt', 'r').read()
        RAMX, RAMY, RAMK = 110, 40, 70
        tx1 = (RAMX - RAMK) / 2
        ty1 = (int(visota) - 2 * RAMY) / 4
        rRr = (tx1 * tx1 + ty1 * ty1) / (2 * tx1)
