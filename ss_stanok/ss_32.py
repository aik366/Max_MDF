def ss_32(k, dlina, visota, RAM):
    txt_ss = ''
    if k[7] == 'Фасад':
        txt_ss = open('rs/32/f.txt', 'r').read()
        ...
        txt_ss = open('rs/32/st.txt', 'r').read()
        RAMX, RAMY, RAMK = 105, 73, 35.36 + int(visota) * 0.18
        ty1 = (int(visota) - 2 * RAMK) / 2
        tx1 = RAMX - RAMY
        rRr1, rRr2 = 30, (tx1 ** 2 + ty1 ** 2) / (2 * tx1)
        ...
        txt_ss = open('rs/32/xl.txt', 'r').read()
        ...
        txt_ss = open('rs/32/xlst.txt', 'r').read()
        RAMX, RAMY, RAMK = 105, 73, 35.36 + int(dlina) * 0.18
        ty1 = (int(dlina) - 2 * RAMK) / 2
        tx1 = RAMX - RAMY
        rRr1, rRr2 = 30, (tx1 ** 2 + ty1 ** 2) / (2 * tx1)
        ...
        txt_ss = open('rs/32/ps.txt', 'r').read()
        ...
        txt_ss = open('rs/32/but.txt', 'r').read()
