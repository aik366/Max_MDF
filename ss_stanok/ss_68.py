def ss_68(k, dlina, visota, RAM):
    ...
    if k[7] == 'Фасад':
        txt_ss = open('rs/68/f.txt', 'r').read()
        if int(visota) < 296:
        ...
        oBv[1] = oBv[7]
        txt_ss = open('rs/68/st.txt', 'r').read()
        if int(visota) < 296:
            RAMX = 45.5 + (int(visota) * 0.07)
            ty1 = 4 + (int(visota) * 0.07)
        else:
        ...
        txt_ss = open('rs/68/xl.txt', 'r').read()
        if int(dlina) < 296:
        ...
        oBv[1] = oBv[7]
        txt_ss = open('rs/68/xlst.txt', 'r').read()
        if int(dlina) < 296:
            RAMX = 45.5 + (int(dlina) * 0.07)
            ty1 = 4 + (int(dlina) * 0.07)
        else:
        ...
        txt_ss = open('rs/68/but.txt', 'r').read()
        ...
        txt_ss = open('rs/68/ps.txt', 'r').read()
        ...
        txt_ss = open('rs/68/pssl.txt', 'r').read()
