def ss_30(k, dlina, visota, RAM):
    txt_ss = ''
    Kant = '10.4' if k[5] == '18' else '14.8'
    if k[7] == 'Фасад':
        txt_ss = open('rs/30/f.txt', 'r').read()
        ...
        txt_ss = open('rs/30/st.txt', 'r').read()
        ...
        txt_ss = open('rs/30/xl.txt', 'r').read()
        ...
        txt_ss = txt_ss.replace("rRr4", f'{rRr4:.3f}')
        txt_ss = txt_ss.replace("ux1", f'{ux1:.3f}')
        txt_ss = txt_ss.replace("ux2", f'{ux2:.3f}')
        txt_ss = txt_ss.replace("uy1", f'{uy1:.3f}')
        txt_ss = txt_ss.replace("uy2", f'{uy2:.3f}')
        ...
        txt_ss = open('rs/30/xlst.txt', 'r').read()
        ...
        txt_ss = open('rs/30/ps.txt', 'r').read()
    ...
    elif k[7] in ('ПСЯ', 'Бутыл.') and 131 <= int(visota) <= 155:
        txt_ss = open('rs/30/pssl.txt', 'r').read()
